...
%token  NULL_LITERAL KEY_PROCEDURE KEY_VAR KEY_CHARPTR KEY_INTPTR KEY_REALPTR KEY_STRING KEY_INTEGER KEY_REAL KEY_BOOLEAN KEY_CHAR KEY_ELSE KEY_IF KEY_RETURN KEY_FOR KEY_WHILE OP_AND OP_EQ OP_GE OP_LE OP_NE OP_OR OP_NE STRING_LITERAL IDENTIFIER KEY_VOID
...
%token  TRUE_LITERAL FALSE_LITERAL INTEGER_LITERAL HEX_LITERAL REAL_LITERAL
...
%type <num> INTEGER_LITERAL HEX_LITERAL REAL_LITERAL
...
//PROCEDURE : KEY_PROCEDURE1 IDENT2 PARAN_O3 PARAM_L4 PARAN_C5 KEY_RETURN6 TYPE7 BRA_O8 BODY9 BRA_C10 {$$ = make_procedure_node($2,$4,$7,$9);}

PROCEDURE :TYPE  IDENT PARAN_O PARAM_L PARAN_C  BRA_O BODY BRA_C {$$ = make_procedure_node($2,$4,$1,$7);}
		  ;		
...
SPARAMS : TYPE PARAMS   {$$ = make_params($1,$2);}
		;
...
VAR_DECS : VAR_DEC VAR_DECS {$$ = $2; $2->list[$2->i++] = $1;}
		 | {$$ = make_var_dec_list();}
		 ;
//VAR_DEC : KEY_VAR1 PARAMS2  ARTYPE3 SEMICOLON4 {$$ = make_var_decs($3,$2);}
VAR_DEC : KEY_VAR   ARTYPE PARAMS SEMICOLON {$$ = make_var_decs($2,$3);}
		;
